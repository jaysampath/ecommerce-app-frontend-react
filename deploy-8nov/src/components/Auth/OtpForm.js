...
const OtpForm = (props) => {
  ...
  if (!params) {
    window.location.href = "https://ecommerce-app-frontend-react-jaysampath.vercel.app/login";
  }
  ...
  const cancelButtonHandler = () => {
    window.location.href = "https://ecommerce-app-frontend-react-jaysampath.vercel.applogin";
  };
      ...
      .then((data) => {
        ...
        if (data["status"] !== 202) {
          ...
          const locationTimer = setTimeout(() => {
            authCtx.login(email);
            window.location.href = "https://ecommerce-app-frontend-react-jaysampath.vercel.app/";
